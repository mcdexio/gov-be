...
export function handleVote(event: VoteEvent): void {
	...
	let vote         = new Vote(event.params.id.toString().concat('-').concat(account.id))
	...
	{
		case 0: vote.content = 'INVALID'; break;
		case 1: vote.content = 'FOR';     break;
		case 2: vote.content = 'AGAINST'; break;
	}
	account.save()
	vote.save()
}
